      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <Link href="/subscription-tiers" className="text-gray-700 hover:text-indigo-600 font-medium">
              Subscription Plans
            </Link>
            <Link href="/crowdfunding" className="text-gray-700 hover:text-indigo-600 font-medium">
              Crowdfunding
            </Link>
            <Link href="/how-it-works" className="text-gray-700 hover:text-indigo-600 font-medium">
              How It Works
            </Link>
            <Link href="/about-us" className="text-gray-700 hover:text-indigo-600 font-medium">
              About Us
            </Link>
          </nav>
