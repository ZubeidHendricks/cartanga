        ...
        <div className="container mx-auto px-4 py-16 md:py-24">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/signup" className="bg-white text-indigo-700 hover:bg-indigo-50 px-6 py-3 rounded-lg font-medium transition duration-300">
                Join Now
              </Link>
              <Link href="/how-it-works" className="bg-transparent border border-white hover:bg-white hover:text-indigo-700 px-6 py-3 rounded-lg font-medium transition duration-300">
                How It Works
              </Link>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/signup" className="bg-white text-indigo-700 hover:bg-indigo-50 px-8 py-4 rounded-lg font-medium text-lg transition duration-300">
                Get Started Today
              </Link>
            </div>
          </div>
